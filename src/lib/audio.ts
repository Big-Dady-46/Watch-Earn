// Web Audio API Sound Synthesizer for rich audio feedback
// No external assets required, works seamlessly offline and on any device
...
class SoundEffects {
  ...
  // Cash register "Cha-ching!" sound for earning PKR
  playCashRegisterSound() {
    try {
      ...
      // Audio playback fails silently if muted
    }
  }

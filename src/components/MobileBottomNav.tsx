...
import { Home, CheckSquare, Wallet, Gift, User, Plus, Play } from 'lucide-react';
...
export default function MobileBottomNav({ onOpenAuth }: MobileBottomNavProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-black/[0.08] px-4 py-2 shadow-2xl">
      <div className="flex items-center justify-around max-w-md mx-auto">
        ...
        {/* Center Main Action Pill Button */}
        <Link
          href="/tasks"
          onClick={() => sounds.playClick()}
        ...
        <Link
          ...
          onClick={() => sounds.playClick()}
          className={`p-2.5 rounded-2xl flex flex-col items-center transition-all ${
            pathname === '/spin' ? 'text-[#191C21] font-bold bg-black/[0.04]' : 'text-[#64748B] hover:text-[#191C21]'
          }`}
          title="Spin & Win"
        >
